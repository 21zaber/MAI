...
%%
trange = 0 : 0.025 : 2 * pi;
%Эллипс: a = 0.5, b = 0.2, ? = ?/3, x0 = 0, y0 = 0
%Эллипс: a = 0.7, b = 0.7, ? = 0, x0 = 0.08, y0 = 0.05
%Парабола: p = ?1, ? = ??/2, x0 = 0, y0 = ?0.8
...
legend('Исходное множество 1', 'Обучающее множество 1', 'Контрольное множество 1', 'Тестовое множество 1',...
    'Исходное множество 2', 'Обучающее множество 2', 'Контрольное множество 2', 'Тестовое множество 2',...
    'Исходное множество 3', 'Обучающее множество 3', 'Контрольное множество 3', 'Тестовое множество 3');
